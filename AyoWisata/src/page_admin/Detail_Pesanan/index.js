...
const Detail_Pesanan = ({navigation, route}) => {
    ...
    useEffect(()=> {
        getData('administrator').then(res => {setProfile(res)})
        getDataUser()
    }, [profile.uid])
    ...
    const button = () => {
        if (status === 'Menunggu Konfirmasi'){
            ...
            return(
                <>
                    <Button title='Konfirmasi Pesanan' onPress={()=> onConfirmation()}/>
                    <Gap height={10}/>
                </>
            )
        }        
        if (status === 'Pesanan di Proses'){
            const sendData = {
            ...
            return(
                <>
                    <Button title='Pesanan Siap Dikirim' onPress={()=> onConfirmation()}/>
                    <Gap height={10}/>
                </>
            )
        }
        if (status === 'Pesanan Siap Dikirim'){
            const sendData = {
            ...
            return(
                <>
                    <Button title='Konfirmasi ke Lokasi' onPress={()=> onConfirmation()}/>
                    <Gap height={10}/>
                </>
            )
        }
                  ...
                  />
                    ...
                    <View style={styles.addressBox}>
                        ...
                        <View style={{flexDirection: 'row', justifyContent: 'space-between',flex: 1, alignItems: 'center', paddingRight: 15}}>
                            ...
                            <Text style={styles.addressText1}>Rp.{getNumber(data.totalPrice)},-</Text>
                        </View>
                        <Gap height={30}/>
                    </View>
                </View>
